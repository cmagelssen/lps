...
Model 6: Total acceleration during baseline and retention in the local positioning section

\begin{verbatim}
model_accumpath <- brm(data = d_lps_accum, 
                       family = gaussian,
                       formula = path_sum ~ 0 + acc_gate:session + (0 + acc_gate:session | skier),
                       prior = priors,
                       control = list(adapt_delta = 0.95),
                       iter = 4000,
                       cores= 4,
